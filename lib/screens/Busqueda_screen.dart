...
class Busqueda_screen extends StatefulWidget {
  ...
  const Busqueda_screen({super.key, this.selectedCategoryId,required this.currentuser}) ;
...
class _Busqueda_screenState extends State<Busqueda_screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CustomBottomNavBar(currentIndex: 2,currentuser: widget.currentuser,),
    );
  }
